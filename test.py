...
def parse_args():
    ...
    parser.add_argument('--config',type=str,
                        default='/home/hzc/CodeRepository/UnderwaterEnhancement/DeepLearning/CNN/UWEnhancement/config/UWCNN.py',
                        help='train config file path')
    parser.add_argument('--load_from',
                        default='/home/hzc/CodeRepository/UnderwaterEnhancement/DeepLearning/CNN/UWEnhancement/checkpoints/UWCNN/UWCNN_type3.pth',
